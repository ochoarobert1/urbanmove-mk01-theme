<?php
add_action( 'tgmpa_register', 'urbanmove_register_required_plugins' );
 ...
 */
function urbanmove_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'urbanmove_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
